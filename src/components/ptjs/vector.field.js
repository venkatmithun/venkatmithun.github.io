...
window.demoDescription =
  "If this is a sphere, it would visualize Hairy Ball Theorem, where you can't comb a hairy ball flat without creating a cowlick. This demo was done in javascript ES6 and compiled with babel.";
...
var Comb = (function (_Circle) {
  ...
  function Comb() {
    ...
    _get(Object.getPrototypeOf(Comb.prototype), "constructor", this).apply(
      this,
      args
    );
...
var VectorLine = (function (_Vector) {
  ...
  function VectorLine() {
    ...
    _get(
      Object.getPrototypeOf(VectorLine.prototype),
      "constructor",
      this
    ).apply(this, args);
  ...
  _createClass(VectorLine, [
    {
      ...
      value: function initVec() {
        ...
        (_direction = this.direction).set
          .apply(_direction, arguments)
          .normalize();
        (_pointer = this.pointer).set
          .apply(_pointer, arguments)
          .multiply(this.mag / 4);
        return this;
      },
    },
    ...
    },
    {
      ...
      value: function checkRange() {
        ...
        if (comb.intersectPoint(this.x, this.y)) {
          ...
          color =
            "rgba(" +
            Math.ceil((this.pointer.y / comb.radius) * 100 + 150) +
            ", 50, " +
            Math.ceil((this.pointer.x / comb.radius) * 100 + 150);
